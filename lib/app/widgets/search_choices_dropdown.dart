  ...
  TextStyle get _textStyle =>
      ...
      (_enabled && !widget.readOnly
          ? Theme.of(context)
              .textTheme
              .subtitle1
              .copyWith(fontFamily: 'AvenirNext')
          : Theme.of(context)
              .textTheme
              .subtitle1
              .copyWith(color: _disabledIconColor, fontFamily: 'AvenirNext'));
  bool get _enabled =>
      widget.items != null &&
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        IconTheme(
                          data: IconThemeData(
                            color: hasSelection && _enabled && !widget.readOnly
                                ? _enabledIconColor
                                : _disabledIconColor,
                            size: widget.iconSize,
                          ),
      ...
      children: <Widget>[
          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(
                    color: validatorOutput is String
                        ? Colors.red
                        : Colors.grey[800],
                    width: validatorOutput is String ? 2.0 : 1.0),
        ...
        valid
            ...
            : validatorOutput is String
                ? Container(
                    padding: EdgeInsets.fromLTRB(14, 10, 16, 0),
                    child: CustomText(
                      validatorOutput,
                      textDirection: widget.rightToLeft
                          ? TextDirection.rtl
                  ...
                  child: Container(
                      ...
                      child: CustomText(
                        ...
                        textDirection: widget.rightToLeft
                            ? TextDirection.rtl
                            : TextDirection.ltr,
                        fontSize: defaultButtonStyle.fontSize,
                        fontWeight: defaultButtonStyle.fontWeight,
