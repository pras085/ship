...
class SearchLocationLokasiTrukSiapMuatController extends GetxController {
  ...
  void onClickSetPositionMarker() async {
    var result =
      ...
      SearchLocationMapMarkerController.imageMarkerKey:
        ...
        numberOfMarker == ""
            ? SvgPicture.asset("assets/marker_transporter_icon.svg")
            : SvgPicture.asset(
                numberOfMarker != "1"
        ...
        numberOfMarker == ""
            ? SizedBox.shrink()
            : Container(
                child: CustomText(numberOfMarker,
