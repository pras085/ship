...
class SearchLocationBFTM
    extends GetView<SearchLocationBFTMController> {
  @override
                                      ...
                                      child: InkWell(
                                          ...
                                          child: Container(
                                              ...
                                              height: GlobalVariable.ratioWidth(
                                                  ...
                                                  24,
                                              child: Center(
                                                  child: Image.asset(GlobalVariable.urlImageTemplateBuyer + "backnew.png", fit: BoxFit.cover,))))),
                                ),
                              ),
                              SizedBox(
                                width:
                                     ...
                                     Obx(
                                      () => CustomTextField(
                                          ...
                                          newInputDecoration: InputDecoration(
                                            ...
                                            isCollapsed: true,
                                            hintText:
                                                "Cari Alamat", //alamat palsu // controller.hintText.value,
          ...
          child: Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start,                        children: [
                ...
                Padding(
                  ...
                  child: Image.asset(GlobalVariable.urlImageTemplateBuyer + "lokasi.png",  width: GlobalVariable.ratioWidth(Get.context) * 18, height: GlobalVariable.ratioWidth(Get.context) * 18, fit: BoxFit.cover),
                ),
                SizedBox(
