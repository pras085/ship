...
import '../../ubah_data_pribadi_controller.dart';
...
class SearchLocationMapMarkerDataPribadiView extends GetView<SearchLocationMapMarkerDataPribadiController> {
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            _button(
                                onTap: () async {
                                  final UbahDataPribadiController ubahDataPribadiC = Get.find();
                                  log('refo');
                                  ...
                                  if (result != null) {
                                    ...
                                    ubahDataPribadiC.distid.value = result["Data"]["districtid"].toString();
