...
class UbahDataPribadiView extends GetView<UbahDataPribadiController> {
  @override
        ...
        children: [
          ...
          Obx(
            () => _button(
              ...
              marginBottom: 16,
              borderRadius: 18,
              onTap: () => controller.isFilled.value == false ? {} : controller.submitPerubahan(),
        ...
        children: [
          ...
          AbsorbPointer(
            ...
            child: DropdownOverlay(
              ...
              value: controller.kodepos.value != "" ? controller.kodepos.value.toString() : null,
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SvgPicture.asset(
                            isOpen ? 'assets/ic_chevron_up.svg' : 'assets/ic_chevron_down.svg',
