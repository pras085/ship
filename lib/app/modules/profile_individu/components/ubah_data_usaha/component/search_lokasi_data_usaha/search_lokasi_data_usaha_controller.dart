...
class SearchLocationDataUsahaController extends GetxController {
  ...
  void onClickSetPositionMarker() async {
    var result = await GetToPage.toNamed<SearchLocationMapMarkerController>(Routes.PETA_UBAH_DATA, arguments: {
      SearchLocationMapMarkerController.latLngKey: _latLngFromArgms,
      SearchLocationMapMarkerController.imageMarkerKey: Stack(alignment: Alignment.topCenter, children: [
        Image.asset(
          'assets/pin_new.png',
