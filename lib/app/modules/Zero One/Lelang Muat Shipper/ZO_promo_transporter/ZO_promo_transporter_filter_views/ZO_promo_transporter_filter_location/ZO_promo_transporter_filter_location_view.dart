...
class ZoPromoTransporterFilterLocationView
    extends GetView<ZoPromoTransporterFilterLocationController> {
        ...
        child: controller.listSelectedLocation.length == 0
            ...
            : ConstrainedBox(
                constraints: BoxConstraints(
                    minWidth: double.infinity, minHeight: 30, maxHeight: 107),
                child: Scrollbar(
                  isAlwaysShown: true,
                  child: SingleChildScrollView(
                    ...
                    child: Obx(
                      () => Wrap(
                        ...
                        runSpacing: GlobalVariable.ratioWidth(Get.context) * 10,
                        children: [
                          for (var index = 0;
                              index < controller.listSelectedLocation.length;
                              index++)
                            Container(
                        ...
                        () => Expanded(
                          child: Stack(
                            ...
                            children: [
                              Obx(
                                () => CustomTextField(
                                    key: ValueKey("CariLelangMuatanFilter"),
                                    context: Get.context,
                                    newContentPadding:
                                                ...
                                                child: Obx(
                                                  () => CustomText(
                                                      ...
                                                      fontWeight:
                                                          FontWeight.w600,
                                                      color: index == 0 ||
                                                              (controller.listTempLocation[index]["Initial"] !=
                                                                  controller
                                                                          .listTempLocation[index - 1]
                                                                      [
                                                                      "Initial"])
                                                          ? Colors.black
                                                          : Colors.transparent,
