...
class ZoListMuatanView extends GetView<ZoListMuatanController> {
  var controller = Get.put(ZoListMuatanController());
                          ...
                          children: [
                            CustomTextField(
                              ...
                              newInputDecoration: InputDecoration(
                                ...
                                hintText:
                                    "LelangMuatBuatLelangBuatLelangLabelTitleCariMuatan"
                                        .tr,
        ...
        body: Obx(
          () => Stack(
            children: [
                ...
                children: [
                  Container(
                    margin: EdgeInsets.only(
                        ...
                        bottom:
                            (controller.listSelectedList.length > 0) ? 16 : 0),
                    child: controller.listTempList.length > 0
                        ? CustomText(controller.title.value,
                  ...
                  Container(
                    margin: EdgeInsets.symmetric(
                        horizontal:
                            GlobalVariable.ratioWidth(Get.context) * 20),
                    child: controller.listSelectedList.length == 0
                        ? SizedBox.shrink()
                        : ConstrainedBox(
                              ...
                              child: SingleChildScrollView(
                                child: Wrap(
                                  ...
                                  children: [
                                    for (var index = 0;
                                        index <
                                            controller.listSelectedList.length;
                                        index++)
                                      Container(
                  ...
                  controller.listSelectedList.length > 0
                      ? Container(
                  ...
                  Expanded(
                    child: ListView.builder(
                        itemCount: controller.listTempList.length,
                            ...
                            child: Column(
                              ...
                              children: [
                                Material(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      if (controller.listSelectedList.any(
                                          (element) =>
                                              element ==
                                              controller.listTempList[index])) {
                                        controller.listSelectedList.removeWhere(
                                            (element) =>
                                                element ==
                                                controller.listTempList[index]);
                                      } else {
                                        controller.listSelectedList.add(
                                            controller.listTempList[index]);
                                      }
                                    },
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          CheckBoxCustom(
                                              ...
                                              isWithShadow: true,
                                              value: controller.listSelectedList
                                                  .any((element) =>
                                                      element ==
                                                      controller
                                                          .listTempList[index]),
              ...
              controller.listTempList.length == 0
                  ? Positioned.fill(
                      child: Container(
