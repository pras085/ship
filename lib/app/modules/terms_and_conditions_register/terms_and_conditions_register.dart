...
class TermsAndConditionsRegisterView extends GetView<TermsAndConditionsRegisterController> {
  @override
          ...
          body: Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/bg_umum_biru_1.png"),
                fit: BoxFit.fill
              )
            ),
            child: Stack(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Container(
                                child: CustomText(
                                  "GeneralLRTermsLabelSyaratKetentuan".tr,
                                  fontSize: 18,
                              ...
                              Obx(() => _button(
                                ...
                                onTap: controller.isOK.value ? () {
                                  GetToPage.toNamed<PrivacyPolicyRegisterController>(
                                    Routes.PRIVACY_AND_POLICY_REGISTER,
