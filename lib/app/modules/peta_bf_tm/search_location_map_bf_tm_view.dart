...
import 'package:muatmuat/app/core/models/district_model.dart';
...
class PetaBFTMView
    extends GetView<PetaBFTMController> {
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                  ...
                                  child: CustomText(
                                      "Mohon memasukkan pin lokasi dengan benar",
                                      fontSize: 12,
            ...
            child: Container(
              child: Obx(
                () => Container(
                  ...
                  decoration: 
                  BoxDecoration(
                    borderRadius: BorderRadius.only(topLeft: Radius.circular(GlobalVariable.ratioWidth(context) * 26), topRight: Radius.circular(GlobalVariable.ratioWidth(context) * 26)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: GlobalVariable.ratioWidth(context) * 13.26,),
                      CustomText('Lokasi', fontSize: 14, fontWeight: FontWeight.w700, color: Color(ListColor.colorBlue),),
                   ...
                   _button(
                    ...
                    _button(
                      ...
                      final RegisterShipperBfTmController registercontroller = Get.find();
                       log('refo');
                       var result = await ApiHelper(context: Get.context, isShowDialogLoading: false, isShowDialogError: false).fetchInformationLatlong(controller.currentLang.value.toString(), controller.currentLong.value.toString());
                       if (result != null) {
                       controller.districtid.value = result["Data"]["districtid"].toString();
                       registercontroller.distid.value = result["Data"]["districtid"].toString();
