...
import 'package:muatmuat/app/modules/other_side_transporter/peta_lokasi_profile_perusahaan/peta_lokasi_profile_perusahaan_view.dart';
import 'package:muatmuat/app/modules/other_side_transporter/profile_perusahaan_controller.dart';
import 'package:muatmuat/app/modules/other_side_transporter/profile_perusahaan_model.dart';
...
class ProfilePerusahaanMapComponentt extends StatefulWidget {

  final ProfilePerusahaanModel model;

  const ProfilePerusahaanMapComponentt({
    Key key,
    @required this.model,
  }) : super(key: key);
...
class _ProfilePerusahaanMapComponentState extends State<ProfilePerusahaanMapComponentt> {
            ...
            Material(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Get.to(PetaLokasiProfilePerusahaanViews());
                  // GetToPage.toNamed<ProfilePerusahaanController>(
                  //     Routes.PROFILE_PERUSAHAAN_VIEW_LOCATION,
                  //   );
                },
                child: Container(
