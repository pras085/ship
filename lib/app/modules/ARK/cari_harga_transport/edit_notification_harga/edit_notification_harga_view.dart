...
class EditNotificationHargaView
    extends GetView<EditNotificationHargaController> {
  String bullet = "\u2022 ";
  @override
                          ...
                          children: [
                            ...
                            Positioned(
                                child: Align(
                                    ...
                                    child: Container(
                                      child: CustomText(
                                        "CariHargaTransportIndexUbahPengaturanNotifikasiHarga"
                                            .tr, //Ubah Pengaturan Notifikasi Harga
                                        height: 1.2,
                                                        ...
                                                        children: [
                                                          Expanded(
                                                              child: Container(
                                                                  child:
                                                                      CustomText(
                                                            'CariHargaTransportIndexUbahNotifikasiHarga'
                                                                .tr, // Ubah Notifikasi Harga
                                                            fontWeight:
                                                                FontWeight.w700,
                                                            fontSize: 14,
                                                          ))),
