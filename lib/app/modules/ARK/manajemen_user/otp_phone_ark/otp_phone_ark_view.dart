...
import 'package:muatmuat/app/modules/ARK/extra_widget/background_stack_widget.dart';

import 'otp_phone_ark_controller.dart';

class OtpPhoneARKView extends GetView<OtpPhoneARKController> {
  ...
  Widget panelCountDownOTP(var context) {
    return SingleChildScrollView(
        child: Column(
            ...
            children: [
          SizedBox(height: GlobalVariable.ratioWidth(Get.context) * 62),
          SvgPicture.asset(
            GlobalVariable.imagePath + "verify_phone_icon.svg",
          ...
          Container(
            ...
            child: CustomText(
              "ManajemenUserBuatPasswordEmailDanPasswordAndaBerhasilDibuat".tr,
              fontSize: 14,
          ...
          CustomText("ManajemenUserBuatPasswordKodeOTPDikirimKeNomor".tr,
              fontSize: 14,
              fontWeight: FontWeight.w500,
          ...
          Row(
            ...
            children: [
              ...
              Obx(() => _button(
                  height: 32,
                  width: 68,
                  text: "ManajemenUserBuatPasswordChange".tr,
                  color:
                  ...
                  onTap:
                      !controller.loading.value && controller.endTime.value == 0
                          ? () {
                              controller.errorMessageDialog.value = "";
          ...
          Obx(() => RichText(
              ...
              text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                        text: "GeneralLROTPLabelKodeOTPAktivasiBerakhirDalam"
                            .tr
                            .replaceAll("\\n", "\n")),
                    TextSpan(
                        ...
                        //     " ",
                        text: controller.endTime.value != 0
                            ? (Duration(seconds: controller.endTime.value)
                                    .toString()
                                    .substring(
                                        2,
                                        Duration(
                        ...
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.w700)),
                    TextSpan(text: "ManajemenUserBuatPasswordMenit".tr),
                  ]))),
          ...
          Obx(
            () => _button(
                height: 33,
                width: 109,
                text: "ManajemenUserBuatPasswordKirimUlang".tr,
                color:
                    !controller.loading.value && controller.endTime.value == 0
                        ? Color(ListColor.colorBlue)
                        : Color(ListColor.colorGrey3),
      ...
      () => GestureDetector(
        child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: controller.errorOtp.value
    ...
    return Obx(
      () => MaterialButton(
        ...
        shape: RoundedRectangleBorder(
            ...
            borderRadius: BorderRadius.all(
                Radius.circular(GlobalVariable.ratioWidth(Get.context) * 30))),
        onPressed: () {
  ...
  void ubahNoHandphoneDialog({
    ...
    GlobalAlertDialog.showAlertDialogCustom(
      context: Get.context,
      title: "ManajemenUserBuatPasswordUbahNoWhatsapp".tr,
      // barrierColor: Colors.transparent,
      isShowButton: false,
      customMessage: Builder(builder: (context) {
        final ctrl = Get.put(OtpPhoneARKController());
        return Column(
          mainAxisSize: MainAxisSize.min,
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: SvgPicture.asset(
                        GlobalVariable.imagePath + "ic_whatsapp_seller.svg",
                    ...
                    Expanded(
                      child: CustomTextField(
                        ...
                        onChanged: (value) {
                          ...
                          if (value == ctrl.phoneNumber.value) {
                            ctrl.errorMessageDialog.value =
                                "ManajemenUserBuatPasswordNoWhatsappTidakBolehSama"
                                    .tr;
                          } else {
                            ctrl.errorMessageDialog.value = "";
                          }
                        ...
                        newInputDecoration: InputDecoration(
                          ...
                          isCollapsed: true,
                          hintText:
                              "ManajemenUserBuatPasswordMasukkanNoWhatsapp".tr,
                          fillColor: Colors.white,
                          hintStyle: TextStyle(
            ...
            Obx(
              () => Align(
                ...
                child: _buttonDynamic(
                  label: "ManajemenUserBuatPasswordSimpan".tr,
