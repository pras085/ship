...
class DialogChangeNumberARK extends StatefulWidget {
  final dialogFormKey;
  ...
  @override
  _DialogChangeNumberARKState createState() => _DialogChangeNumberARKState();
}

class _DialogChangeNumberARKState extends State<DialogChangeNumberARK> {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    //           borderRadius: BorderRadius.all(Radius.circular(GlobalVariable.ratioWidth(Get.context) * 13)),
