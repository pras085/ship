...
import 'create_info_pra_tender_view.dart';

class CreateInfoPraTenderController extends GetxController {
  ...
  Future<void> onInit() async {
    ...
    if (Get.arguments != null) {
      ...
      updateTitle();
      tanggalDibuat.value = dateFormat.format(dateNow);
      ...
      await secondPageinit();
      await thirdPageinit();
      await fourthPageinit();
      await fifthPageinit();
    }
  ...
  Future getDetail(String idPraTender, int halaman) async {
    ...
    if (result['Message']['Code'].toString() == '200') {
      ...
      tanggalDibuat.value = dateFormat
          .format(await GlobalVariable.getDateTimeFromServer(Get.context));
      selectedFile.value = null;
      updateTitle();
      ...
      for (var x = 0; x < data['kualifikasi_pratender'].length; x++) {
        persyaratanController.text += data['kualifikasi_pratender'][x]['detail']
                .replaceAll("<br>", "\n") ??
            "";
      }
  ...
  void onSetData(String tipe) async {
    ...
    if (tipe == "SAVE" && save) {
      ...
      if (result['Message']['Code'].toString() == '200') {
        ...
        CustomToast.show(
            context: Get.context,
            message: "InfoPraTenderCreateLabelInfoBerhasilMenyimpanData"
                .tr); //Berhasil menyimpan data yang telah dibuat
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border.all(
                          color: dataTahapTender[index]['error_min_date'] != ""
                              ? Color(ListColor.colorRed)
                              : Color(ListColor.colorGrey2),
                          width: 1),
                        ...
                        Expanded(
                          child: Obx(
                            () => CustomText(
                              ...
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
                              color: dataTahapTender[index]['min_date'] != ''
  ...
  void cekBelumTerpakai() async {
    ...
    if (satuanTender.value == 2) {
      ...
      print(jmltruktersedia);
      print(jumlahYangDigunakan.value.toInt());
              ...
              GestureDetector(
                  onTap: () async {
                    ...
                    if (result != null) {
                      ...
                      await hitungTotalYangDigunakan(false);

                      //JIKA ERRORNYA MUNCUL BARU BERSIHKAN
