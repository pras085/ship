...
class CreateInfoPraTenderView extends GetView<CreateInfoPraTenderController> {
        ...
        child: AnnotatedRegion<SystemUiOverlayStyle>(
            ...
            child: SafeArea(
              ...
              appBar: AppBar(
                ...
                title: CustomText(
                    "InfoPraTenderCreateLabelBuatInfoPraTender"
                        .tr, //"Buat Info Pra Tender".tr,
                    fontSize: 16,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: GlobalVariable.ratioWidth(Get.context) * 24),
            CustomText(
                "InfoPraTenderCreateLabelJenisMuatan".tr + "*", // Jenis Muatan
                fontWeight: FontWeight.w700,
                fontSize: 14,
                color: Color(ListColor.colorGrey3)),
            SizedBox(height: GlobalVariable.ratioWidth(Get.context) * 8),
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  CustomTextFormField(
                    ...
                    newInputDecoration: InputDecoration(
                      ...
                      isCollapsed: true,
                      hintText:
                          "InfoPraTenderCreateLabelContoh".tr, // Contoh : 50
                      hintStyle: TextStyle(
                        fontWeight: FontWeight.w600,
                        color: Color(ListColor.colorLightGrey2),
                      ),
                            ...
                            Container(
                              ...
                              child: CustomTextField(
                                ...
                                newInputDecoration: InputDecoration(
                                  ...
                                  isDense: true,
                                  isCollapsed: true,
                                  hintText: "InfoPraTenderCreateLabelP".tr, //p
                                  hintStyle: TextStyle(
                                    fontWeight: FontWeight.w600,
                                    fontSize: 14,
                                    color: Color(ListColor.colorLightGrey2),
                            ...
                            Container(
                              ...
                              child: CustomTextField(
                                ...
                                newInputDecoration: InputDecoration(
                                  ...
                                  isDense: true,
                                  isCollapsed: true,
                                  hintText: "InfoPraTenderCreateLabelL".tr, //l
                                  hintStyle: TextStyle(
                                    fontWeight: FontWeight.w600,
                                    fontSize: 14,
                                    color: Color(ListColor.colorLightGrey2),
                              ...
                              SizedBox(
                                  width:
                                      GlobalVariable.ratioWidth(Get.context) *
                                          9),
                              CustomText(
                                  'InfoPraTenderCreateLabelTotal'.tr, // Total
                                  fontSize: 14,
                                  fontWeight: FontWeight.w700,
                                  color: Color(ListColor.colorGrey3))
                            ],
  ...
  void save() async {
    ...
    if (controller.validasiSimpan) {
      ...
      if (controller.slideIndex.value != saveIndex) {
        ...
        controller.cekTambah = await SharedPreferencesHelper.getHakAkses(
            "Buat Info Pra Tender",
            denganLoading: true);
