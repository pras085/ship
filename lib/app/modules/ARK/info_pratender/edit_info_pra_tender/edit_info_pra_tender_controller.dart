...
import 'edit_info_pra_tender_view.dart';

class EditInfoPraTenderController extends GetxController {
  ...
  var kodePraTender =
      'InfoPraTenderCreateLabelAutoGenerate'.obs; // autogenerate
  var judulController = TextEditingController();
  var dataTahapTender = [].obs;
  var namaTahapTender = [
    "",
    "InfoPraTenderCreateLabelInfoPraTender", //Info Pra Tender
    "InfoPraTenderCreateLabelProsesTender", //Proses Tender
    "InfoPraTenderCreateLabelSeleksiPemenang", //Seleksi Pemenang
    "InfoPraTenderCreateLabelPengumumanPemenang", //Pengumuman Pemenang
    "InfoPraTenderCreateLabelEksekusiTender" //Eksekusi Tender
  ];
  ...
  Future getDetail(String idPraTender, int halaman) async {
    isLoading.value = true;
    ...
    if (result['Message']['Code'].toString() == '200') {
      ...
      print(data['tahap_tender'][0]['tanggal_dimulai']);
      print(DateTime.parse(data['tahap_tender'][0]['tanggal_dimulai']));
      ...
      List<int> dropdown_tender = [2, 3, 4, 5];
      ...
      for (var x = 0; x < data['tahap_tender'].length; x++) {
        ...
        //DAPATKAN TAHAP TENDER TERAKHIR
        List<int> dropdown_tender = [];
        //SETTING COMBOGRID
        for (var index = (lastTahap + 1); index <= 5; index++) {
          dropdown_tender.add(index);
        }
        ...
        dataTahapTender.add({
          ...
          'show_last_date': data['tahap_tender'][x]['tanggal_akhir_format_new'],
          'min_date':
              DateTime.parse(data['tahap_tender'][x]['tanggal_dimulai']),
          'max_date': DateTime.parse(data['tahap_tender'][x]['tanggal_akhir']),
          'error_tahap_tender': '',
          'error_min_date':
          ...
          'dropdown_tender': dropdown_tender
        });
      }

      if (DateTime.parse(data['tahap_tender'][0]['tanggal_dimulai']).compareTo(
              await GlobalVariable.getDateTimeFromServer(Get.context)) <=
          0) {
        tipeEdit = "SEKARANG";
      } else if (DateTime.parse(data['tahap_tender'][0]['tanggal_dimulai'])
              .compareTo(
                  await GlobalVariable.getDateTimeFromServer(Get.context)) >
          0) {
        tipeEdit = "SEBELUM";
      ...
      for (var x = 0; x < data['kualifikasi_pratender'].length; x++) {
        if (tipeEdit == "SEBELUM") {
          persyaratanController.text += data['kualifikasi_pratender'][x]
                      ['detail']
                  .replaceAll("<br>", "\n") ??
              "";
        } else {
    ...
    if (satuanTender == 2) {
      switch (slideIndex.value) {
        case 0:
          {
            title.value =
                'InfoPraTenderCreateLabelDataPraTender'; //'Data Pra Tender'
            break;
          }
        case 1:
          {
            title.value = 'InfoPraTenderCreateLabelDataMuatan'; //Data Muatan
            break;
          }
        case 2:
          {
        ...
        case 3:
          {
            title.value =
                'InfoPraTenderCreateLabelRuteYangDitenderkan'; // Rute Yang Ditenderkan
            break;
          }
        case 4:
          {
            title.value = 'InfoPraTenderCreateLabelPersyaratanKualifikasi'
                .tr; // Persyaratan Kualifikasi
            break;
          }
      }
    } else {
  ...
  void onSetData(String tipe) async {
    ...
    for (var x = 0; x < dataTahapTender.length; x++) {
      var data = {
    ...
    if (tipe == "SAVE" && save) {
      ...
      if (result['Message']['Code'].toString() == '200') {
        ...
        if (nama_file.value == "") {
          ...
          CustomToast.show(
              context: Get.context,
              message: "InfoPraTenderEditNotifikasiBerhasilMenyimpan".tr);
        }
      } else {
        save = true;
        Get.back();
  ...
  void hapusFileTender() async {
    var result = await ApiHelper(
            ...
            isShowDialogLoading: false,
            isShowDialogError: false)
        .hapusFileInfoPraTender(idPraTender);
    ...
    if (result['Message']['Code'].toString() == '200') {
      ...
      CustomToast.show(
          context: Get.context,
          message: "InfoPraTenderEditNotifikasiBerhasilMenyimpan"
  ...
  Widget listTahapTenderWidget(int index) {
    ...
    //SETTING AWAL JIKA BELUM PERNAH ADA TAMBAH

    //SET DROPDOWN KETIKA ATA TAHAP TENDER SUDAH LEBIH DARI 1
    if (dataTahapTender.length > 1) {
      for (var x = 0; x < dataTahapTender[index]['dropdown_tender'].length; x++)
        dropDownMenu.add(DropdownMenuItem(
          child: Container(
              padding: EdgeInsets.only(
                  top: GlobalVariable.ratioWidth(Get.context) * 2),
              child: CustomText(
                  namaTahapTender[dataTahapTender[index]['dropdown_tender'][x]]
                      .tr,
                  fontSize: 14,
                  color: Color(ListColor.colorLightGrey4),
                  fontWeight: FontWeight.w600)),
          value: dataTahapTender[index]['dropdown_tender'][x],
        ));
    }
    ...
    return Obx(() => Column(children: [
            ...
            children: [
              ...
              Expanded(
                  child: index == 0
                      ? Container(
                          child: CustomText(
                              dataTahapTender[index]['tahap_tender'] == 1
                                  ? namaTahapTender[1].tr
                                  : ''.toString().tr,
                              fontWeight: FontWeight.w600,
                              fontSize: 14,
                              color: Color(ListColor.colorDarkGrey3)))
                      : Column(
                          ...
                          children: [
                              Obx(() => DropdownBelow(
                                    itemWidth: MediaQuery.of(Get.context)
                                            .size
                                            .width -
                                    ...
                                    boxWidth: MediaQuery.of(Get.context)
                                            .size
                                            .width -
                                        GlobalVariable.ratioWidth(Get.context) *
                                            109,
                                    ...
                                    hint: CustomText(
                                        ...
                                        color: Color(ListColor.colorLightGrey4),
                                        fontWeight: FontWeight.w600),
                                    value: dataTahapTender[index]
                                        ['tahap_tender'],
                                    items: [
                                      for (var x = 0;
                                          x < dropDownMenu.length;
                                          x++)
                                        dropDownMenu[x]
                                    ],
                                    onChanged: (value) {
                                      dataTahapTender[index]['tahap_tender'] =
                                          value;

                                      //JIKA DIA YANG EKSEKUSI TENDER, HAPUS SEMUA DIATAS EKSEKUSI TENDER
                                      if (value == 5) {
                                        int indexHapus = dataTahapTender
                                            .indexWhere((element) =>
                                                element['tahap_tender'] ==
                                                value);

                                        for (var x = dataTahapTender.length - 1;
                                            x >= (indexHapus + 1);
                                            x--) {
                                          dataTahapTender.removeAt(x);
                                        }
                                      }
                                      dataTahapTender.refresh();
                              ...
                              dataTahapTender[index]['error_tahap_tender'] != ""
                                  ? Column(
          ...
          Row(
            children: [
              ...
              Expanded(
                child:
                    CustomText('InfoPraTenderCreateLabelPeriode'.tr, // Periode
                        fontWeight: FontWeight.w600,
                        fontSize: 12,
                        color: Color(ListColor.colorGrey3)),
              )
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Expanded(
                child: index == 0 && tipeEdit == "SEKARANG"
                    ? Container(
                        // padding: EdgeInsets.only(
                                  ...
                                  child: Obx(
                                    () => CustomText(
                                      (dataTahapTender[index]['min_date'] == ''
                                          ? 'InfoPraTenderCreateLabelFirstDate'
                                              .tr //Tanggal Awal
                                          : dataTahapTender[index]
                                              ['show_first_date']),
                                      fontSize: 14,
            ...
            Container(
              child: CustomText(
                  ' ' + 'InfoPraTenderCreateLabelSampaiDengan'.tr + ' ', // s/d
                  fontSize: 14,
                  color: Color(ListColor.colorLightGrey4),
                  fontWeight: FontWeight.w600),
            ),
                      ...
                      Expanded(
                        child: CustomText(
                          (dataTahapTender[index]['max_date'] == ''
                              ? 'InfoPraTenderCreateLabelLastDate'
                                  .tr // Tanggal Akhir
                              : dataTahapTender[index]['show_last_date']),
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
            ...
            Container(
              child: dataTahapTender.length == 1 && index == 0
                  ? Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                    width:
                                        GlobalVariable.ratioWidth(Get.context) *
                                            9),
                                dataTahapTender[index]['tahap_tender'] == 5
                                    ? SizedBox(
                                        width:
                                            GlobalVariable.ratioWidth(
                                                    Get.context) *
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      child: CustomText(
                          ' ' +
                              'InfoPraTenderCreateLabelSampaiDengan'.tr +
                              ' ', // s/d
                          fontSize: 12,
                          color: Colors.transparent),
                    ),
  ...
  Widget kebutuhanTrukSebelumPraTenderWidget(index) {
    return Container(
        child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        CustomText(
            dataTrukTender.length > 1
                ? ('InfoPraTenderCreateLabelKebutuhan'.tr +
                    ' #' +
                    (index + 1).toString().tr) // Kebutuhan
                : ('InfoPraTenderCreateLabelKebutuhan'.tr), // Kebutuhan
            ...
            child: AbsorbPointer(
              ...
              () => CustomTextFormField(
                ...
                newInputDecoration: InputDecoration(
                  ...
                  isDense: true,
                  isCollapsed: true,
                  hintText: "InfoPraTenderCreateLabelJenisTruk".tr, //Jenis Truk
                  hintStyle: TextStyle(
                    fontWeight: FontWeight.w600,
                    color: Color(ListColor.colorLightGrey4),
                  ),
                ...
                validator: (value) {
                  if (value == "" || !validasiSimpan) {
                    return "InfoPraTenderCreateLabelAlertJenisTruk"
            ...
            onTap: () async {
              ...
              if (!cekRuteDitenderkanSudahAda() ||
                ...
                GlobalAlertDialog.showAlertDialogCustom(
                    ...
                    message:
                        "InfoPraTenderCreateLabelPerubahanTrukCarrier" //Apakah anda yakin ingin melakukan perubahan data jenis truk/carrier ? Data yang telah diisi pada rute yang ditenderkan akan hilang
                            .tr,
                    labelButtonPriority1: GlobalAlertDialog.noLabelButton,
            ...
            child: AbsorbPointer(
              ...
              () => CustomTextFormField(
                ...
                newInputDecoration: InputDecoration(
                  ...
                  isCollapsed: true,
                  hintText:
                      "InfoPraTenderCreateLabelJenisCarrier".tr, //Jenis Carrier
                  hintStyle: TextStyle(
                    fontWeight: FontWeight.w600,
                    color: Color(ListColor.colorLightGrey4),
                  ),
                ...
                validator: (value) {
                  if (value == "" || !validasiSimpan) {
                    return "InfoPraTenderCreateLabelAlertJenisCarrier"
                ...
                () => dataTrukTender[index]['gambar_truk'].isEmpty
                    ? Column(
                        ...
                        children: [
                          ...
                          Container(height: 4),
                          CustomText(
                              'InfoPraTenderCreateLabelPilihJenisTrukdanCarrier'
        ...
        SizedBox(height: GlobalVariable.ratioWidth(Get.context) * 24),
        CustomText(
            'InfoPraTenderCreateLabelEstimasiKapasitasDimensiVolume'
        ...
        SizedBox(height: GlobalVariable.ratioWidth(Get.context) * 24),
        CustomText('InfoPraTenderCreateLabelJumlahTruk'.tr, //Jumlah Truk
            fontWeight: FontWeight.w700,
            fontSize: 14,
            color: Color(ListColor.colorGrey3)),
        SizedBox(height: GlobalVariable.ratioWidth(Get.context) * 6),
                            ...
                            onTap: () {
                              ...
                              if (!cekRuteDitenderkanSudahAda()) {
                                ...
                                GlobalAlertDialog.showAlertDialogCustom(
                                    context: Get.context,
                                    title:
                                        "InfoPraTenderCreateLabelInfoKonfirmasiPerubahan"
                                            .tr, //Konfirmasi Perubahan
                                    message:
                                        "InfoPraTenderCreateLabelPerubahanTrukCarrier" //Apakah anda yakin ingin melakukan perubahan data jenis truk/carrier ?  Data yang telah diisi pada rute yang ditenderkan akan hilang
                                            .tr,
  ...
  Widget kebutuhanTrukPraTenderWidget(index) {
    return Container(
        child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  void tambahTahapTender() {
    ...
    dataTahapTender.add({
      ...
      'show_first_date': 'InfoPraTenderCreateLabelFirstDate'.tr, //Tanggal Awal
      'show_last_date': 'InfoPraTenderCreateLabelLastDate'.tr, // Tanggal AKhir
      'min_date': '',
      'max_date': '',
      'error_tahap_tender': '',
      'error_min_date': '',
  ...
  void hapusTahapTender(int index) {
    if (index != dataTahapTender.length - 1) {
      dataTahapTender[index + 1]['dropdown_tender'] =
          dataTahapTender[index]['dropdown_tender'];
    }
  ...
  void cekBelumTerpakai() async {
    ...
    if (satuanTender.value == 2) {
      ...
      if (jumlahYangDigunakan.value.toInt() < jmltruktersedia) {
        ...
        errorFourthPage.value = "InfoPraTenderCreateLabelAlertSisaUnitTruk"
      ...
      if (jumlahYangDigunakan.value.toDouble() <
        ...
        validasiSimpan = false;
        errorFourthPage.value = "InfoPraTenderCreateLabelAlertSisaBerat"
      ...
      if (jumlahYangDigunakan.value.toDouble() >
          double.parse(
              GlobalVariable.formatDoubleDecimal(beratController.text))) {
        validasiSimpan = false;
        errorFourthPage.value = "InfoPraTenderCreateLabelAlertBeratHeavier"
      ...
      if (jumlahYangDigunakan.value.toDouble() <
        ...
        validasiSimpan = false;
        errorFourthPage.value = "InfoPraTenderCreateLabelAlertSisaVolume"
      ...
      if (jumlahYangDigunakan.value.toDouble() >
          double.parse(
              GlobalVariable.formatDoubleDecimal(volumeController.text))) {
        validasiSimpan = false;
        errorFourthPage.value = "InfoPraTenderCreateLabelAlertVolumeHeavier"
  ...
  void chooseFile() async {
    ...
    if (pickedFile != null) {
      ...
      if (nama_file.value
        ...
        selectedFile.value = null;
        nama_file.value = "";
        errorFifthPage.value = "InfoPraTenderCreateAlertFileFormatSalah"
            .tr; // File yang Anda pilih lebih dari 8 MB
      }
      if (sizeInMb > 8) {
        selectedFile.value = null;
        nama_file.value = "";
        errorFifthPage.value = "InfoPraTenderCreateAlertFileBesar"
            .tr; // File yang Anda pilih lebih dari 8 MB
      }
    }
  }
  ...
  //FOURTH PAGE
  Widget unitTrukRuteDitenderkanSebelumPraTenderWidget(int index) {
    return Obx(
      () => Column(
        children: [
          SizedBox(height: GlobalVariable.ratioWidth(Get.context) * 24),
          Row(
            ...
            children: [
              ...
              GestureDetector(
                  ...
                  child: CustomText(
                      "InfoPraTenderCreateLabelIsiDataRute".tr, // Isi Data Rute
                      fontWeight: FontWeight.w600,
                          ...
                          GestureDetector(
                              onTap: () async {
                                GlobalAlertDialog.showAlertDialogCustom(
                                    ...
                                    title: "".tr,
                                    message:
                                        "InfoPraTenderCreateAlertButtonResetDataRute" //Apakah anda yakin ingin mereset rute ini? Data rute yang telah diisi akan hilang
                                            .tr,
                                    labelButtonPriority1:
                                        GlobalAlertDialog.noLabelButton,
                                    onTapPriority1: () async {},
                              ...
                              child: CustomText(
                                  "InfoPraTenderCreateLabelReset".tr, // Reset
                                  fontWeight: FontWeight.w600,
                                  textAlign: TextAlign.right,
                                  fontSize: 12,
                                  height: 1.2,
                ...
                children: [
                  Obx(
                    () => CustomText(
                        dataRuteTender[index]['pickup'] == "" &&
                                dataRuteTender[index]['destinasi'] == ""
                            ? "InfoPraTenderCreateLabelRuteBelumDitentukan"
                  ...
                  Container(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomText(
                            'InfoPraTenderCreateLabelJenisTruk'
                                .tr, // Jenis Truk
                            fontSize: 14,
                            ...
                            ? Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: CustomText(
                                            "InfoPraTenderCreateLabelBelumDitentukan"
                                                .tr, // Belum Ditentukan
                                            fontSize: 14,
                                            fontWeight: FontWeight.w600,
                                            color: Color(
  ...
  Widget beratRuteDitenderkanSebelumPraTenderWidget(int index) {
    return Obx(() => Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
                  ...
                  child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: CustomText(
                              "InfoPraTenderDetailLabelPickUp".tr, // Pick Up
                              fontWeight: FontWeight.w600,
                              fontSize: 12,
                              color: Color(ListColor.colorGrey3)),
                        ),
                        GestureDetector(
                            child: Container(
                                ...
                                child: CustomText(
                                    dataRuteTender[index]['pickup'] == ""
                                        ? "InfoPraTenderCreateLabelLokasiPickup".tr //Lokasi Pickup
                                        : dataRuteTender[index]['pickup'],
                                    fontWeight: FontWeight.w600,
                                    fontSize: 14,
                        ...
                        GestureDetector(
                            child: Container(
                                ...
                                child: CustomText(
                                    dataRuteTender[index]['destinasi'] == ""
                                        ? "InfoPraTenderCreateLabelDestinasi".tr // Lokasi Destinasi
                                        : dataRuteTender[index]['destinasi'],
                                    fontWeight: FontWeight.w600,
                                    fontSize: 14,
  ...
  Widget volumeRuteDitenderkanSebelumPraTenderWidget(int index) {
    return Obx(() => Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: CustomText(
                              "InfoPraTenderDetailLabelVolume".tr, // Volume
                              fontWeight: FontWeight.w600,
                              fontSize: 12,
                              color: Color(ListColor.colorGrey3)),
                        ),
                            ...
                            Expanded(
                                child: CustomTextFormField(
                                    ...
                                    newInputDecoration: InputDecoration(
                                        ...
                                        isCollapsed: true,
                                        hintText:
                                            "InfoPraTenderCreateLabelContoh"
                                                .tr, // Contoh : 50
                                        hintStyle: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          color:
  ...
  void cekLokasiKembar(int index) {
    if (dataRuteTender[index]['pickup'] != "" &&
      ...
      validasiSimpan = false;
      dataRuteTender[index]['error_lokasi_kembar'] =
          "InfoPraTenderCreateLabelAlertDataRuteSama"
  ...
  Widget unitTrukRuteDitenderkanPraTenderWidget(int index) {
  ...
  Widget beratRuteDitenderkanPraTenderWidget(int index) {
    return Obx(() => dataRuteTender[index]['pickup'] != "" &&
            dataRuteTender[index]['destinasi'] != ""
        ? Column(
            children: [
  ...
  Widget volumeRuteDitenderkanPraTenderWidget(int index) {
    return Obx(() => dataRuteTender[index]['pickup'] != "" &&
            dataRuteTender[index]['destinasi'] != ""
        ? Column(
            children: [
