...
class ListDestinasiFilterArkController extends GetxController {
  final listCity = {}.obs;
  ...
  void onInit() {
    listCity.addAll(
        _getSortingByValue(Map<String, dynamic>.from(Get.arguments[0])));
    listChoosen.addAll(Get.arguments[1]);
    if (Get.arguments[2] != null) hintText.value = Get.arguments[2];
