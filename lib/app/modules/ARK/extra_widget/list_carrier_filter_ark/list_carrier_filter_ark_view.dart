...
import 'list_carrier_filter_ark_controller.dart';

class ListCarrierFilterArkView extends GetView<ListCarrierFilterArkController> {
  @override
            ...
            onTap: () {
              controller.onCheckDiumumkan(
                  controller.getIndexList(
                      controller.listDiumumkanTemp.value[index]['name']),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    width: GlobalVariable.ratioWidth(Get.context) * 65,
                    decoration: BoxDecoration(
                      color: Colors.white,
                      border: Border.all(
                    ...
                    child: controller
                            .listDiumumkanTemp.value[index]['image'].isEmpty
                        ...
                        : CachedNetworkImage(
                            ...
                            imageBuilder: (context, imageProvider) => Container(
                              ...
                              // height:
                              //     GlobalVariable.ratioWidth(Get.context) * 59,
                              decoration: BoxDecoration(
                                  // border: Border.all(
                                  //     color: Color(ListColor.colorStroke),
                                  //     style: BorderStyle.solid,
                    ...
                    onChanged: (value) {
                      controller.onCheckDiumumkan(
                          controller.getIndexList(controller
                              .listDiumumkanTemp.value[index]['name']),
                          !value);
                    },
