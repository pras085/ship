...
class ListProvinceFilterArkController extends GetxController {
  final listCity = {}.obs;
  ...
  void onInit() {
    listCity
        .addAll(_getSortingByValue((jsonDecode(jsonEncode(Get.arguments[0])))));
  ...
  Map<String, dynamic> _getSortingByValue(Map<String, dynamic> data) {
    var sortedKeys = data.entries.toList(growable: false)
      ..sort((k1, k2) {
        // List<String> listVal1 = data[k1];
        // List<String> listVal2 = data[k2];
        // String val1 = "";
        // String val2 = "";
