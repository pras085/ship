...
class ContactPartnerInfoPraTenderTransporterModalSheetBottomController
  ...
  void showContact(
    ...
    if (contactData.value == null) {
      _getContact(shipperID, onReceiveContact);
      _getWA(shipperID, onReceiveContact);
    }
                ...
                : Column(
                    ...
                    children: [
                      ...
                      _optionView(
                        ...
                        "InfoPraTenderTransporterIndexLabelTerhubungDenganInboxShipper"
                            .tr,
                        () async {
                          // Get.back();
                          // openPhoneDialog();
  ...
  Future _getWA(String shipperID,
      void Function(ContactTransporterByShipperModel) onReceiveContact) async {
    ContactShipperModel response =
        await GetContactShipperByTransporter.getWA(shipperID);
    if (response != null) {
