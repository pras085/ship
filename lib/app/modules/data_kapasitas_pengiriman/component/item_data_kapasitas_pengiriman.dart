...
class ItemDataKapasitasComponent extends StatefulWidget {
  final String title;
  final List<FileKapasitas> files;
  ...
  const ItemDataKapasitasComponent({
    Key key,
    @required this.title,
    this.files,
    this.valueString,
  ...
  @override
  _ItemDataKapasitasComponentState createState() => _ItemDataKapasitasComponentState();
}

class _ItemDataKapasitasComponentState extends State<ItemDataKapasitasComponent> {
  final ctrl = Get.find<DataKapasitasPengirimanController>();
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (widget.files != null && widget.files.length > 1) _iconDownload(context),
            ],
          ),
                ...
                child: ScrollParentComponent(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      if (fFormat == "ZIP" || fFormat == "PDF" || fFormat == "PNG" || fFormat == "JPG" || fFormat == "XLS") {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                if (widget.files.length == 1) _iconDownload(context),
                              ],
                            ),
                          ],
                        ),
          ...
          if (widget.isOpsional)
            Column(
              ...
              children: [
                ...
                CustomText(
                  "Format file jpg/png/pdf max. 5MB",
                  fontWeight: FontWeight.w400,
                  fontSize: 12,
                  color: Color(ListColor.colorGrey3),
                ),
            ...
            onTapPriority1: () async {
              try {
                final response = await ApiProfile(
                  ...
                  // 'file': widget.files.map((e) => e.data.map((f) => f.file.map((g) => g.fileID)).toList().toString()),
      ...
      child: Material(
        ...
        child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.circular(GlobalVariable.ratioWidth(context) * borderRadius)),
              child: Center(
