...
import 'package:muatmuat/app/modules/ubah_data_perusahaan/component/search_location_map/search_location_map_controller.dart';
...
class SearchLocationUbahDataMapView extends GetView<SearchLocationUbahDataMapController> {
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            _button(
                                onTap: () async {
                                  final UbahDataPerusahaanController ubahDataPerusahaanController = Get.find();
                                  log('refo');
                                  ...
                                  if (result != null) {
                                    ...
                                    ubahDataPerusahaanController.distid.value = result["Data"]["districtid"].toString();
