...
class TermsAndConditionsBFTMView extends GetView<TermsAndConditionsBFTMController> {
  @override
                          ...
                          children: [
                            Container(
                              ...
                              child: Obx(() => CustomText(
                                "${"BFTMRegisterAllSyaratDanKetentuan".tr} ${controller.tipeModul.value == TipeModul.BF ? "Big Fleets" : "Transport Market"}",
                                fontSize: 18,
                            ...
                            for (int i = 0; i < controller.listPoint.length; i++)
                              i == 0 ? SizedBox.shrink() : Container(
                                margin: EdgeInsets.only(
                                  top: i == 1 ? GlobalVariable.ratioWidth( Get.context) * 24
                                        ...
                                        child: Html(
                                          ...
                                          style: {
                                            ...
                                            'p': Style(
                                              ...
                                              lineHeight: LineHeight(15.96/12),
                                              color: Colors.white,
                                              fontWeight: FontWeight.w500,
                                            ),
                                          },
                            ...
                            Obx(() => _button(
                              ...
                              color: Color(
                                controller.isOK.value ? ListColor.colorBlue : ListColor.colorLightGrey4
                              ),
                              backgroundColor: Color(
                                controller.isOK.value ? ListColor.colorYellow : ListColor.colorLightGrey2
                              ),
                              height: 36,
                              fontSize: 14,
