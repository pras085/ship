...
import 'ringkasan_manajemen_notifikasi_controller.dart';

class RingkasanManajemenNotifikasiView extends GetView<RingkasanManajemenNotifikasiController> {
  @override
                              ...
                              content: Column(
                                children: [
                                  for(int i = 0; i < controller.listModelManajemenVerifikasiBf.length; i++)...[
                                    if((controller.selectedEmailValue.value == "-1" || int.parse(controller.selectedEmailValue.value) == controller.listModelManajemenVerifikasiBf[i].emailNotif) ||
                                        (controller.selectedAplikasiValue.value == "-1" || int.parse(controller.selectedAplikasiValue.value) == controller.listModelManajemenVerifikasiBf[i].pushNotif))...
                                    [
                                      Container(
                                            ...
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  GestureDetector(
                                                    onTap: () async {
                                                      var response = await GetToPage.toNamed<ManajemenNotifikasiEmailController>(Routes.MANAJEMEN_NOTIFIKASI_EMAIL);
                                                      if(response != null) {
                                                        controller.getInit();
                                                      }
                                                    },
                                                    child: SvgPicture.asset(
                                                      controller.listModelManajemenVerifikasiBf[i].emailNotif == 1 
                                                        ? "assets/ic_manajemen_notifikasi_email_on.svg"
                                                        : "assets/ic_manajemen_notifikasi_email_off.svg",
                                                  ...
                                                  GestureDetector(
                                                    onTap: () async {
                                                      var response = await GetToPage.toNamed<ManajemenNotifikasiAplikasiController>(Routes.MANAJEMEN_NOTIFIKASI_APLIKASI);
                                                      if(response != null) {
                                                        controller.getInit();
                                                      }
                                                    },
                                                    child: SvgPicture.asset(
                                                      controller.listModelManajemenVerifikasiBf[i].pushNotif == 1 
                                                        ? "assets/ic_manajemen_notifikasi_push_on.svg"
                                                        : "assets/ic_manajemen_notifikasi_push_off.svg",
                                                      width: GlobalVariable.ratioWidth(context) * 24,
                                                      height: GlobalVariable.ratioWidth(context) * 24,
                                                    ),
                                                  ),
                              ...
                              content: Column(
                                children: [
                                  for(int i = 0; i < controller.listModelManajemenVerifikasiTm.length; i++)...[
                                    if((controller.selectedEmailValue.value == "-1" || int.parse(controller.selectedEmailValue.value) == controller.listModelManajemenVerifikasiTm[i].emailNotif) ||
                                        (controller.selectedAplikasiValue.value == "-1" || int.parse(controller.selectedAplikasiValue.value) == controller.listModelManajemenVerifikasiTm[i].pushNotif))...
                                    [
                                      Container(
                                        margin: EdgeInsets.symmetric(
                                          horizontal: GlobalVariable.ratioWidth(context) * 16
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  GestureDetector(
                                                    ...
                                                    child: SvgPicture.asset(
                                                      controller.listModelManajemenVerifikasiTm[i].emailNotif == 1 
                                                        ? "assets/ic_manajemen_notifikasi_email_on.svg"
                                                        : "assets/ic_manajemen_notifikasi_email_off.svg",
                                                      width: GlobalVariable.ratioWidth(context) * 24,
                                                      height: GlobalVariable.ratioWidth(context) * 24,
                                                  ...
                                                  GestureDetector(
                                                    ...
                                                    child: SvgPicture.asset(
                                                      controller.listModelManajemenVerifikasiTm[i].pushNotif == 1 
                                                        ? "assets/ic_manajemen_notifikasi_push_on.svg"
                                                        : "assets/ic_manajemen_notifikasi_push_off.svg",
                                                      width: GlobalVariable.ratioWidth(context) * 24,
                                                      height: GlobalVariable.ratioWidth(context) * 24,
