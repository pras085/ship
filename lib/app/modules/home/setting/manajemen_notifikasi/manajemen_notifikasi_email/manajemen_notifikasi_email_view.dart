...
import 'manajemen_notifikasi_email_controller.dart';

class ManajemenNotifikasiEmailView extends GetView<ManajemenNotifikasiEmailController> {
  @override
                                        ...
                                        Obx(() =>
                                          Container(
                                            ...
                                            child: FlutterSwitch(
                                              width: GlobalVariable.ratioWidth(context) * 40,
                                              // height: GlobalVariable.ratioWidth(context) * 24,
                                              value: controller.listModelManajemenVerifikasiGeneral[0].emailNotifToggle.value,
                                              onToggle: (val) async {
                                          ...
                                          Obx(() =>
                                            Container(
                                              ...
                                              child: FlutterSwitch(
                                                width: GlobalVariable.ratioWidth(context) * 40,
                                                // height: GlobalVariable.ratioWidth(context) * 24,
                                                value: controller.listModelManajemenVerifikasiBf[i].emailNotifToggle.value,
                                                onToggle: (val) async {
                                          ...
                                          Obx(() =>
                                            Container(
                                              ...
                                              child: FlutterSwitch(
                                                width: GlobalVariable.ratioWidth(context) * 40,
                                                // height: GlobalVariable.ratioWidth(context) * 24,
                                                value: controller.listModelManajemenVerifikasiTm[i].emailNotifToggle.value,
                                                onToggle: (val) async {
