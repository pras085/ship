...
class FilterManajemenLokasiView
    extends GetView<FilterManajemenLokasiController> {
  @override
              ...
              Obx(
                () => Column(
                  ...
                  children: [
                    ...
                    controller.listSelectedLocation.length > 0
                        ? Container(
                            height: GlobalVariable.ratioHeight(Get.context) * 2,
                            margin: EdgeInsets.only(
                                left:
                                    GlobalVariable.ratioWidth(Get.context) * 20,
                                right:
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                height:
                                    GlobalVariable.ratioWidth(Get.context) * 95,
                              )),
                              Container(
                                height:
