...
class SubscriptionRiwayatPesananListController extends GetxController {
  final posTab = 0.obs;
  ...
  RefreshController refreshControllerEP =
      RefreshController(initialRefresh: false);
  final listAP = <SubscriptionListRiwayatPesananModel>[].obs;
  final listCO = <SubscriptionListRiwayatPesananModel>[].obs;
  final listEP = <SubscriptionListRiwayatPesananModel>[].obs;
  var radioTypeAP = ''.obs;
  var radioTypeCO = ''.obs;
  var radioTypeEP = ''.obs;
  var tempRadioTypeAP = '';
  ...
  doFilter(int offset, int posTab) async {
    ...
    if (posTab == 0) {
      ...
      data.forEach((element) {
        listAP.add(SubscriptionListRiwayatPesananModel.fromJson(element));
      });
      ...
      List<dynamic> data = resultFilter["Data"];
      data.forEach((element) {
        listCO.add(SubscriptionListRiwayatPesananModel.fromJson(element));
      });
      ...
      List<dynamic> data = resultFilter["Data"];
      data.forEach((element) {
        listEP.add(SubscriptionListRiwayatPesananModel.fromJson(element));
      });
  ...
  void onClickSearch() {
    if (listAP.length > 0 ||
      ...
      GetToPage.toNamed<SubscriptionRiwayatPesananListSearchController>(
