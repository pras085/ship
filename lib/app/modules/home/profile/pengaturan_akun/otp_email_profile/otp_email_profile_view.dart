...
class OtpEmailProfileView extends GetView<OtpEmailProfileController> {
  ...
  void ubahEmailDialog({
    ...
    controller.changeEmailValue.value = "";
      ...
      customMessage: Builder(builder: (context) {
        return Column(
          ...
          children: [
            Obx(() =>
              Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(
                        width: GlobalVariable.ratioWidth(Get.context) * 1,
                        color: controller.errorMessageDialog.value.trim().isEmpty
                  ...
                  children: [
                    ...
                    Expanded(
                      child: CustomTextFormField(
                        ...
                        autofocus: false,
                        onChanged: (value) {
                          controller.changeEmailValue.value = value;
                          controller.errorMessageDialog.value = "";
                          // do some validation here
                          // if (RegExp(r"^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,253}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,253}[a-zA-Z0-9])?)*$").hasMatch(value)) {
                          //   controller.errorMessageDialog.value = 'GlobalValidationLabelPenulisanEmailSalah'.tr;
                          //   return;
                          // } else {
                          //   controller.errorMessageDialog.value = "";
                          // }
            ...
            Obx(() {
              if (controller.errorMessageDialog.value.trim().isNotEmpty) {
                return Column(
                  children: [
                    const SizedBox(
                      height: 3,
            ...
            Obx(
              () => Align(
                ...
                child: _buttonDynamic(
                  ...
                  onPressed: controller.changeEmailValue.value.trim().isEmpty
                      ? null
                      : onSubmit,
                ),
              ),
