...
class FormPhoneProfileView extends GetView<FormPhoneProfileController> {
  @override
  Widget build(BuildContext context) {
    print('build form phone profile');
    return Container(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: SvgPicture.asset(
                        'assets/ic_input_phone_profile.svg',
                        width: GlobalVariable.ratioWidth(Get.context) * 120,
                      )
                    ),
                    Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: CustomText(
                                      "Pastikan nomor Whatsapp Anda aktif karena kami akan mengirim kode verifikasi ke nomor ini",
                                      fontSize: 12,
                                      ...
                                      onTap: () async { 
                                        if (controller.isFilled.value) {
                                          ...
                                          if(controller.isValid.value) {
                                            ...
                                            // GetToPage.toNamed<OtpPhoneProfileController>(Routes.OTP_PHONE_PROFILE, arguments: controller.phoneController.text);
                                            
                                            MessageFromUrlModel message;
                                            
                                            var body = {
                                              "phone_baru": controller.phoneController.text,
                                            ...
                                            if (message != null && message.code == 200) {
                                              GetToPage.offNamed<OtpPhoneProfileController>(
                                                Routes.OTP_PHONE_PROFILE, 
                                                arguments: {
