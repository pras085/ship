...
class FormInputPasswordProfileView extends GetView<FormInputPasswordProfileController> {
  @override
  Widget build(BuildContext context) {
    print('build form input password profile');
    return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: CustomText(
                                      "Password baru harus minimal dari 8 karakter, yang terdiri dari huruf besar, huruf kecil dan angka",
                                      fontSize: 12,
                                            ...
                                            children: [
                                              CustomTextFormField(
                                                ...
                                                onChanged: (value) {
                                                  ...
                                                  if (value.isNotEmpty && controller.confirmPasswordController.text.isNotEmpty) {
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              CustomTextFormField(
                                                ...
                                                onChanged: (value) {
                                                  controller.isValid.value = true;
                                                  if (value.isNotEmpty && controller.passwordController.text.isNotEmpty) {
                                                    controller.isFilled.value = true;
                                  ...
                                  Obx(() => 
                                    _button(
                                      ...
                                      onTap: () async {
                                        ...
                                        String confirmPasswordBase64 = base64.encode(utf8.encode(confirmPassword));
                                        ...
                                        if (controller.isFilled.value) {
                                          if (password == confirmPassword) {
                                            ...
                                            var body = {
                                              "password_baru": passwordBase64,
                                              "konfirmasi_pass": confirmPasswordBase64
                                            };
