...
class UbahFotoProfilView extends GetView<UbahFotoProfilController> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!controller.onCreate.value) {
      ...
      if (controller.checkId == 1) {
        controller.getFromGallery();
      } else if (controller.checkId == 2) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBarBlueShipperProfile(
          centerTitle: false,
          preferredSize: Size(double.infinity, GlobalVariable.ratioWidth(Get.context) * 56),
                ...
                child: Container(
                  ...
                  child: _button(
                    ...
                    onTap: () async {
                      ...
                      //   //  profC.update();
                      //   //  profC.dataModelResponse.refresh();
...
class AppBarBlueShipperProfile extends PreferredSize {
  ...
  AppBarBlueShipperProfile({this.preferredSize, this.title, this.bottom, this.heightAppBarOnly, this.customBody, this.centerTitle, this.color});
}
