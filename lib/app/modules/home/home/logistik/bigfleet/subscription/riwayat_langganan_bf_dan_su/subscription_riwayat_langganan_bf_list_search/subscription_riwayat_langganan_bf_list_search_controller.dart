...
import 'package:muatmuat/app/modules/home/home/logistik/bigfleet/subscription/riwayat_langganan_bf_dan_su/subscription_riwayat_langganan_bf_list_search_result/subscription_riwayat_langganan_bf_list_search_result_controller.dart';
import 'package:muatmuat/app/routes/app_pages.dart';
import 'package:muatmuat/app/utils/shared_preferences_helper.dart';

class SubscriptionRiwayatLanggananBFListSearchController
  ...
  Future<void> getHistory() async {
    try {
      var resultJson =
          jsonDecode(await SharedPreferencesHelper.getHistorySubscriptionBF())
              as List;
  ...
  void updateHistory() async {
    ...
    await SharedPreferencesHelper.setHistorySubscriptionBF(
  ...
  void onSubmitSearch() {
    updateHistory();
    SubscriptionRiwayatLanggananBFListSearchResultController
    ...
    if (searchResultController != null)
      ...
      Get.offNamed(Routes.SUBSCRIPTION_RIWAYAT_LANGGANAN_BF_LIST_SEARCH_RESULT,
          arguments: [
            search
            // , filterTransporter
            // , sortShipper
