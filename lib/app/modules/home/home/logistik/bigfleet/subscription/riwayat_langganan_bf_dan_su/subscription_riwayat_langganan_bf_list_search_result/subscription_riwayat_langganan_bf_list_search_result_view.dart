...
class SubscriptionRiwayatLanggananBFListSearchResultView
    extends GetView<SubscriptionRiwayatLanggananBFListSearchResultController> {
  @override
                                  ...
                                  children: [
                                    CustomTextField(
                                        ...
                                        newInputDecoration: InputDecoration(
                                            hintText:
                                                "SubscriptionSubscriptionHistoryAppBar"
                                                    .tr,
                                            hintStyle: TextStyle(
                                                fontWeight: FontWeight.w600,
                                                color: Color(
                                      ...
                                      children: [
                                        ...
                                        TextSpan(
                                            text: controller.listData[index]
                                                        .qtyFreeSubuser >
                                                    0
                                                ? '${controller.listData[index].qtyPaidSubuser > 0 ? " +\n" : ""}${controller.listData[index].qtyFreeSubuser} ${'SubscriptionSubUser'.tr} ${'SubscriptionFree'.tr}'
                                                : '',
                                            style: TextStyle(
                                                color: Color(
