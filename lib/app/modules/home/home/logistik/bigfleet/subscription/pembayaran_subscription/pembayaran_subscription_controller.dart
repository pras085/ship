...
import 'package:muatmuat/app/modules/home/home/logistik/bigfleet/subscription/pembayaran_subscription/pembayaran_subscription_response_model.dart';
import 'package:flutter/services.dart';
import 'package:muatmuat/app/routes/app_pages.dart';

class PembayaranSubscriptionController extends GetxController {
  ...
  void onInit() {
    ...
    if (arguments != null) {
      metodePembayaran = arguments[0] ?? MetodePembayaranModel();
  ...
  void changeMetode() async {
    var result =
        await GetToPage.toNamed<SubscriptionPilihMetodePembayaranController>(
            Routes.SUBSCRIPTION_PILIH_METODE_PEMBAYARAN,
            arguments: [
          subtotal.toDouble(),
          batasPembayaran,
          totalSubuser,
    ...
    if (result != null) {
      ...
      var metode = MetodePembayaranModel(
  ...
  Future<bool> updateMetode(MetodePembayaranModel metode) async {
    ...
    try {
      ...
      if (response != null) {
        PembayaranSubscriptionResponseModel
            pembayaranSubscriptionResponseModel =
            PembayaranSubscriptionResponseModel.fromJson(response);
