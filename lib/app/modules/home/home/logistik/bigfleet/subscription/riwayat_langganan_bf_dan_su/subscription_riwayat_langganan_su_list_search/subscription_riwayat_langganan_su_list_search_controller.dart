...
class SubscriptionRiwayatLanggananSUListSearchController
  ...
  Future<void> getHistory() async {
    try {
      var resultJson =
          jsonDecode(await SharedPreferencesHelper.getHistorySubscriptionSU())
              as List;
  ...
  void updateHistory() async {
    ...
    await SharedPreferencesHelper.setHistorySubscriptionSU(
  ...
  void onSubmitSearch() {
    updateHistory();
    SubscriptionRiwayatLanggananSUListSearchResultController
    ...
    if (searchResultController != null)
      ...
      Get.offNamed(Routes.SUBSCRIPTION_RIWAYAT_LANGGANAN_SU_LIST_SEARCH_RESULT,
          arguments: [
            search
            // , filterTransporter
            // , sortShipper
