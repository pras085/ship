...
class SubscriptionRiwayatLanggananSUListSearchResultController
  ...
  var listData = <SubscriptionListRiwayatSUModel>[].obs;
  var totalAll = 0.obs;
  ...
  doFilter(int offset) async {
    ...
    data.forEach((element) {
      listData.add(SubscriptionListRiwayatSUModel.fromJson(element));
    });
