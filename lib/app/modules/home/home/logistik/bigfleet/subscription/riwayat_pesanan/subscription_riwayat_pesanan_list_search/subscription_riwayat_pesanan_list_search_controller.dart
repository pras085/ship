...
class SubscriptionRiwayatPesananListSearchController extends GetxController {
  var lastSearch = [].obs;
  var lastSearchTemp = [];
  ...
  Future<void> getHistory() async {
    try {
      var resultJson = jsonDecode(await SharedPreferencesHelper
          .getHistorySearchOrderHistorySubscription()) as List;
  ...
  void updateHistory() async {
    ...
    await SharedPreferencesHelper.setHistorySearchOrderHistorySubscription(
  ...
  void onSubmitSearch() {
    updateHistory();
    SubscriptionRiwayatPesananListSearchResultController searchResultController;
    try {
    ...
    if (searchResultController != null)
      ...
      Get.offNamed(Routes.SUBSCRIPTION_RIWAYAT_PESANAN_LIST_SEARCH_RESULT,
          arguments: [
            search
            // , filterTransporter
            // , sortShipper
