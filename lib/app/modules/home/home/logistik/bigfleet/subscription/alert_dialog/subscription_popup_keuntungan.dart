...
class SubscriptionPopupKeuntungan {
  static void showAlertDialog({
    BuildContext context,
    Function onTap,
    bool isDismissible = false,
  }) async {
    SubscriptionHomeController controller;
    try {
      controller = Get.find();
    } catch (err) {}
    if (controller == null) {
    ...
    var initChekbox =
        await SharedPreferencesHelper.getSubscriptionKeuntunganBerlangganan();
                                            ...
                                            CheckBoxCustom(
                                              ...
                                              onChanged: (onChanged) async {
                                                await SharedPreferencesHelper
                                                    .setSubscriptionKeuntunganBerlangganan(
                                                        onChanged);
...
class SubscriptionPopupKeuntunganModel {
  String icon;
  String title;
  String body;

  SubscriptionPopupKeuntunganModel(this.icon, this.title, this.body);
}
