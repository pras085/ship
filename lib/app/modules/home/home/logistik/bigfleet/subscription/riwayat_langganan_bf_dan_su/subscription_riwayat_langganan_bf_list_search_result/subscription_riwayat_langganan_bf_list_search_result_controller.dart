...
class SubscriptionRiwayatLanggananBFListSearchResultController
  ...
  var listData = <SubscriptionListRiwayatBFModel>[].obs;
  var totalAll = 0.obs;
  ...
  doFilter(int offset) async {
    ...
    data.forEach((element) {
      listData.add(SubscriptionListRiwayatBFModel.fromJson(element));
    });
