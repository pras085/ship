class SubscriptionListMenungguPembayaranModel {
  int orderID;
  String packetName;
  ...
  SubscriptionListMenungguPembayaranModel();

  SubscriptionListMenungguPembayaranModel.fromJson(Map<String, dynamic> json) {
    orderID = json['ID'];
