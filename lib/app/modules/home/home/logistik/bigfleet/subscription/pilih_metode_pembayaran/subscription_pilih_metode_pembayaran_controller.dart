...
import 'package:muatmuat/app/modules/home/home/logistik/bigfleet/subscription/pilih_metode_pembayaran/subscription_pilih_metode_pembayaran_response_model.dart';
...
class SubscriptionPilihMetodePembayaranController extends GetxController {
  ...
  Future<void> _getListMetodePembayaran() async {
    ...
    try {
      ...
      if (response != null) {
        SubscriptionPilihMetodePembayaranResponseModel
            pilihMetodePembayaranResponseModel =
            SubscriptionPilihMetodePembayaranResponseModel.fromJson(response);
  ...
  onClickOk() async {
    CategoryMetodePembayaranModel category;
    MetodePembayaranModel content;
    ...
    if (selectedCategory.value == "1") {
      ...
      var result = await GetToPage.toNamed<KartuKreditDebitOnlineController>(
          Routes.KARTU_KREDIT_DEBIT_ONLINE,
          arguments: [
            content,
            jumlahPembayaran,
            batasPembayaran,
