...
import 'package:muatmuat/app/modules/home/home/logistik/bigfleet/subscription/menunggu_pembayaran/subscription_menunggu_pembayaran_list_search_result/subscription_menunggu_pembayaran_list_search_result_controller.dart';
import 'package:muatmuat/app/routes/app_pages.dart';
import 'package:muatmuat/app/utils/shared_preferences_helper.dart';

class SubscriptionMenungguPembayaranListSearchController
  ...
  Future<void> getHistory() async {
    try {
      var resultJson = jsonDecode(await SharedPreferencesHelper
          .getHistorySubscriptionMenungguPembayaran()) as List;
  ...
  void updateHistory() async {
    ...
    await SharedPreferencesHelper.setHistorySubscriptionMenungguPembayaran(
  ...
  void onSubmitSearch() {
    updateHistory();
    SubscriptionMenungguPembayaranListSearchResultController
    ...
    if (searchResultController != null)
      ...
      Get.offNamed(Routes.SUBSCRIPTION_MENUNGGU_PEMBAYARAN_LIST_SEARCH_RESULT,
          arguments: [
            search
            // , filterTransporter
            // , sortShipper
