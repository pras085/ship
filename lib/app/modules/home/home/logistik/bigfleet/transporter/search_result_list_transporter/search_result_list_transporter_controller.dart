...
class SearchResultListTransporterController extends GetxController {
  ...
  List<WidgetFilterModel> listTransporterWidgetFilter = [
    ...
    WidgetFilterModel(
        ...
        keyParam: "Join"),
    WidgetFilterModel(
        label: ["GlobalFilterTransporterLocation".tr],
        typeInFilter: TypeInFilter.CITY,
        keyParam: "TransporterKota"),
    WidgetFilterModel(
        label: ["GlobalFilterServiceArea".tr],
        typeInFilter: TypeInFilter.CITY,
  ...
  FilterCustomController transporterFilter;
  SortingController transporterSorting;
  ListDataDesignFunction listTransporter;
  var loadingTransporter = true.obs;
  var changeTransporter = Map();

  var listTransporterLength = 0.obs;
  var search = "".obs;
  var sortTransporter = Map().obs;
  var listHasilPencarianInlineSpan = [].obs;
  var isSorted = false.obs;
  var isUsingFilter = false.obs;

  var limit = 10;
  var loadingOption = false.obs;
  var transporterID = 1;
  var statusSelected = "0".obs;
  var txtStatusSelected = "".obs;
  var selectedContacts = Map().obs;
  var totalAll = 0.obs;
  ...
  @override
  void onInit() async {
    search.value = Get.arguments[0] as String;
    // _setListHasilPencarian();
    searchBar.text = search.value;
    sortTransporter = Get.arguments[1];
    ...
    listTransporter =
      ...
      if (result != null) {
        changeTransporter.addAll(result);
      }
    });
    transporterSorting = Get.put(
        SortingController(
            listSort: transporterSort,
            onRefreshData: (map) {
              sortTransporter.clear();
              sortTransporter.addAll(map);
              updateIsSorted();
              refreshController.requestRefresh();
              // refreshData(true);
            }),
        tag: "SearchResultListTransporter");
    await refreshData();
  }
  ...
  Future<void> doFilterTransporter(int offset) async {
    ...
    listTransporter.addDataList(newListTransporter
        .map((e) => TransporterListDesignModel(
            ...
            joinDate: e.joinDate,
            isAlreadyBecomePartner: e.isMitra))
        .toList());
  }

  void goToSearchPage() async {
    var result = await GetToPage.toNamed<SearchListTransporterController>(Routes.SEARCH_LIST_TRANSPORTER,
  ...
  //   String isiDesc2 = "Ditemukan ${totalAll.value} hasil pencarian untuk ".tr;
  //   listHasilPencarianInlineSpan.clear();
  //   listHasilPencarianInlineSpan.add(_setTextSpan(isiDesc2, false));
  //   listHasilPencarianInlineSpan.add(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             _setTextSpan("\"${search.value}\"", true));
  //   refreshData();
  // }
  ...
  void updateIsSorted() {
    isSorted.value = sortTransporter.keys.isNotEmpty;
  }

  void getShipperStatus(String shipperID) async {
    loadingOption.value = true;
    var response =
        await ApiHelper(context: Get.context, isShowDialogLoading: false)
            .fetchCheckStatusTransporterAsMitra(
                shipperID, transporterID.toString());
    Map<dynamic, dynamic> responseStatus = response["Data"][0];
    statusSelected.value = responseStatus["Status"].toString();
    updateTextMitra();

    ContactTransporterByShipperResponseModel contactResponse =
        await GetContactTransporterByShipper.getContact(shipperID);
    selectedContacts.clear();
    selectedContacts.addAll(contactResponse.contactDataJson);
    // selectedContacts.value.remove("Avatar");
    loadingOption.value = false;
  }

  void updateTextMitra() {
    switch (statusSelected.value) {
      case "0":
        txtStatusSelected.value = "Tambahkan sebagai Mitra";
        break;
      case "1":
        txtStatusSelected.value = "Batalkan permintaan sebagai mitra";
        break;
      case "2":
        txtStatusSelected.value = "Balas permintaan sebagai Mitra";
        break;
      case "3":
        txtStatusSelected.value = "Hapus Mitra".tr;
        break;
    }
  }

  void showFilter() {
    transporterFilter.showFilter();
  }

  void showSort() {
    transporterSorting.showSort();
  }

  Future<void> refreshData() async {
    await doFilterTransporter(0);
    loadingTransporter.value = false;
  }

  void loadData() {
    doFilterTransporter(listTransporterLength.value);
  }
                ...
                children: [
                  ...
                  showModalBottom.value
                      ? Column(
                          ...
                          mainAxisSize: MainAxisSize.min,
                          children: [
                              Obx(() => getStatusWidget(transporterStatus.value,
                                  transporter, shipperID)),
                              Container(
                              ...
                              itemOption(
                                  ...
                                  onTap: () async {
                                    contactPartner(transporter.transporterID);
                                  }),
                            ])
                      : Container(
  ...
  void approveRejectMitra(String status, TransporterListDesignModel transporter,
    ...
    var message = MessageFromUrlModel.fromJson(response['Message']);
    if (message.code == 200) {
      if (status == "1") refreshController.requestRefresh();
      CustomToast.show(
          context: Get.context,
          message: status == "1"
