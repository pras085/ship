...
class TransportMarketView extends GetView<TransportMarketController> {
  ...
  List<BigfleetMenuIcon> _listMenuIcon = [
    BigfleetMenuIcon('Subscription', "subscription.png",
        ListColor.colorBackgroundCircleBigFleetSubscription, () {
      GetToPage.toNamed<TMSubscriptionHomeController>(
          Routes.TM_SUBSCRIPTION_HOME);
    }),
    BigfleetMenuIcon('Lelang Muatan'.tr, "lelang_muatan_icon.png",
        ListColor.colorBackgroundCircleTransportMarketLelangMuatan, () {
      Get.toNamed(Routes.LIST_TRANSPORTER);
    }),
    BigfleetMenuIcon('Cari Harga Transport'.tr, "cari_harga_transport_icon.png",
        ListColor.colorBackgroundCircleTransportMarketCariHargaTransport, () {
      Get.toNamed(Routes.MANAJEMEN_MITRA);
    }),
    BigfleetMenuIcon('Promo Transporter'.tr, "promo_transporter_icon.png",
        ListColor.colorBackgroundCircleTransportMarketPromoTransporter, () {
