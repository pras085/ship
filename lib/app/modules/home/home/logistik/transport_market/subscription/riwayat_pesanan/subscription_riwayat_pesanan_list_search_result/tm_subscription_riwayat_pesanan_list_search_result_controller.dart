...
class TMSubscriptionRiwayatPesananListSearchResultController
  ...
  var listData = <TMSubscriptionListRiwayatPesananModel>[].obs;
  var totalAll = 0.obs;
  ...
  doFilter(int offset) async {
    ...
    data.forEach((element) {
      listData.add(TMSubscriptionListRiwayatPesananModel.fromJson(element));
    });
  ...
  void goToSearchPage() async {
    var result = await GetToPage.toNamed<
            TMSubscriptionRiwayatPesananListSearchController>(
