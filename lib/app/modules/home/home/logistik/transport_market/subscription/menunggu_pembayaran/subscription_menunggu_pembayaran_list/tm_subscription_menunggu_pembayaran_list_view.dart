...
class TMSubscriptionMenungguPembayaranListView
    extends GetView<TMSubscriptionMenungguPembayaranListController> {
  @override
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        var result = await GetToPage.toNamed<
                                TMSubscriptionDetailController>(
...
class _AppBar extends PreferredSize {
  ...
  final TMSubscriptionMenungguPembayaranListController controller;
