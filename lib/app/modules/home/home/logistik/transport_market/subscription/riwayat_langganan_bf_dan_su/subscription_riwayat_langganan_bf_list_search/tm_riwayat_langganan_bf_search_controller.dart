...
class TMSubscriptionRiwayatLanggananBFListSearchController
  ...
  Future<void> getHistory() async {
    try {
      var resultJson =
          jsonDecode(await SharedPreferencesHelper.getHistoryTMSubscriptionBF())
              as List;
  ...
  void updateHistory() async {
    ...
    await SharedPreferencesHelper.setHistoryTMSubscriptionBF(
  ...
  void onSubmitSearch() {
    ...
    if (searchResultController != null)
      ...
      Get.offNamed(
          Routes.TM_SUBSCRIPTION_RIWAYAT_LANGGANAN_BF_LIST_SEARCH_RESULT,
          arguments: [
            search
            // , filterTransporter
            // , sortShipper
