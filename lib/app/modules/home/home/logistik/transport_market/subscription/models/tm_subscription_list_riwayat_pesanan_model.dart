class TMSubscriptionListRiwayatPesananModel {
  int orderID;
  String packetName;
  ...
  TMSubscriptionListRiwayatPesananModel();

  TMSubscriptionListRiwayatPesananModel.fromJson(Map<String, dynamic> json) {
    orderID = json['ID'];
