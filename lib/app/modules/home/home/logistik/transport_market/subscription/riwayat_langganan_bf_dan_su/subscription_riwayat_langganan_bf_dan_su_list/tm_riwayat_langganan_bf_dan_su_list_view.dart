...
class TMSubscriptionRiwayatLanggananBFDanSUListView
    extends GetView<TMSubscriptionRiwayatLanggananBFDanSUListController> {
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: _AppBar(
              ...
              hintText: controller.tipeLayanan == TMTipeLayananSubscription.BF
              ...
              onSelect: () {
                if (controller.listLength > 0) {
                  if (controller.tipeLayanan == TMTipeLayananSubscription.BF) {
                    GetToPage.toNamed<
                            TMSubscriptionRiwayatLanggananBFListSearchController>(
                        Routes.TM_SUBSCRIPTION_RIWAYAT_LANGGANAN_BF_LIST_SEARCH,
                        arguments: [""]);
                  } else {
                    GetToPage.toNamed<
  ...
  Widget _cardRiwayatLangganan(int index) {
    bool tipeBF = controller.tipeLayanan == TMTipeLayananSubscription.BF;
    return Container(
                ...
                Container(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        if (tipeBF) {
                          GetToPage.toNamed<TMSubscriptionDetailController>(
                              Routes.TM_SUBSCRIPTION_DETAIL,
                              arguments: [
                                controller.listDataBF[index].orderID,
                                TMTipeLayananSubscription.BF,
                                TMTipeDetailSubscription.LANGGANAN
                              ]);
                        } else {
                          GetToPage.toNamed<TMSubscriptionDetailController>(
                              Routes.TM_SUBSCRIPTION_DETAIL,
