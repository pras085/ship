...
class TMSubscriptionDetailView extends GetView<TMSubscriptionDetailController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarDetail(
        ...
        title: controller.tipeDetail == TMTipeDetailSubscription.LANGGANAN
            ? "SubscriptionHistory".tr
            : controller.tipeDetail == TMTipeDetailSubscription.PEMBAYARAN
        ...
        child: Obx(() => controller.loading.value
            ? Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.only(bottom: GlobalVariable.ratioWidth(Get.context) * 20),
                      child: SizedBox(
  ...
  Widget _detailWaktu() {
    ...
    return Table(
      ...
      children: [
        ...
        controller.statusPesanan == 1 &&
                controller.tipeDetail == TMTipeDetailSubscription.PESANAN
            ? TableRow(children: [
                Container(
                  constraints: BoxConstraints(
                      minHeight: GlobalVariable.ratioWidth(Get.context) * 25),
        ...
        controller.statusPesanan == 0
            ...
            : controller.tipeDetail == TMTipeDetailSubscription.LANGGANAN
                ? _kosong()
                : TableRow(children: [
                    Container(
                      constraints: BoxConstraints(
                  ...
                  child: CustomText(
                    controller.statusPesanan == 0 &&
                            controller.tipeDetail ==
                                TMTipeDetailSubscription.PEMBAYARAN
  ...
  Widget _cardRiwayatLangganan(
    ...
    bool tipeBF = controller.tipe == TMTipeLayananSubscription.BF;
    return Container(
      padding:
