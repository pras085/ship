...
class TMCreateSubuserView extends GetView<TMCreateSubuserController> {
  @override
                                                                                        ...
                                                                                        child: Row(
                                                                                          ...
                                                                                          children: [
                                                                                            Expanded(
                                                                                              child: Obx(
                                                                                                () => CustomText(
                                                                                                  controller.listPaketSubuser[index][controller.subuserID] == 0 ? "Pilih Paket" : controller.listPaketSubuser[index][controller.subuserName],
                                                                          ...
                                                                          children: [
                                                                            Obx(
                                                                              () => Container(
                                                                                ...
                                                                                margin: EdgeInsets.only(right: GlobalVariable.ratioWidth(context) * 5),
                        ...
                        decoration: BoxDecoration(
                            color: Color(
                                controller.selectedPeriodeSubuser.isNotEmpty &&
                                        controller.selectedPeriodeSubuser[0] !=
                                            "0" &&
                                        controller.metodePembayaran.isNotEmpty
                                    ? ListColor.color4
