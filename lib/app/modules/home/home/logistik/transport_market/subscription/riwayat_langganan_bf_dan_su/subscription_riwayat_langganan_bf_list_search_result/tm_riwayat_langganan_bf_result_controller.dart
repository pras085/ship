...
class TMSubscriptionRiwayatLanggananBFListSearchResultController
  ...
  var listData = <TMSubscriptionListRiwayatBFModel>[].obs;
  var totalAll = 0.obs;
  ...
  doFilter(int offset) async {
    ...
    data.forEach((element) {
      listData.add(TMSubscriptionListRiwayatBFModel.fromJson(element));
    });
