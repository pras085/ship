...
class TMSubscriptionMenungguPembayaranListSearchController
  ...
  Future<void> getHistory() async {
    try {
      var resultJson = jsonDecode(await SharedPreferencesHelper
          .getHistoryTMSubscriptionMenungguPembayaran()) as List;
  ...
  void updateHistory() async {
    ...
    await SharedPreferencesHelper.setHistoryTMSubscriptionMenungguPembayaran(
  ...
  void onSubmitSearch() {
    updateHistory();
    TMSubscriptionMenungguPembayaranListSearchResultController
    ...
    if (searchResultController != null)
      ...
      Get.offNamed(Routes.TM_SUBSCRIPTION_MENUNGGU_PEMBAYARAN_LIST_SEARCH_RESULT,
          arguments: [
            search
            // , filterTransporter
            // , sortShipper
