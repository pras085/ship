...
import 'package:muatmuat/app/modules/home/home/logistik/transport_market/subscription/models/tm_subscription_list_menunggu_pembayaran_model.dart';
import 'package:muatmuat/app/routes/app_pages.dart';
import 'package:muatmuat/app/style/list_colors.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class TMSubscriptionMenungguPembayaranListSearchResultController
  ...
  var listData = <TMSubscriptionListMenungguPembayaranModel>[].obs;
  var totalAll = 0.obs;
  ...
  doFilter(int offset) async {
    ...
    totalAll.value = data.length;
    data.forEach((element) {
      listData.add(TMSubscriptionListMenungguPembayaranModel.fromJson(element));
    });
  ...
  void goToSearchPage() async {
    var result = await GetToPage.toNamed<
            TMSubscriptionMenungguPembayaranListSearchController>(
        Routes.TM_SUBSCRIPTION_MENUNGGU_PEMBAYARAN_LIST_SEARCH,
