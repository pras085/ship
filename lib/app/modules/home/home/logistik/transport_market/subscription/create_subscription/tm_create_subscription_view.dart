...
class TMCreateSubscriptionView extends GetView<TMCreateSubscriptionController> {
  @override
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: CustomText(
                        "SubscriptionCreateLabelTransportMarket".tr,
                        color: Colors.white,
                        fontSize: 16,
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border(
                  top: BorderSide(
                      width: 1.0, color: Color(ListColor.colorLightGrey10)),
                  bottom: BorderSide(
                      width: 1.0, color: Color(ListColor.colorLightGrey10)))),
          child: Focus(
            onFocusChange: (val) {
