...
import 'package:muatmuat/app/modules/home/home/logistik/transport_market/subscription/riwayat_langganan_bf_dan_su/subscription_riwayat_langganan_su_list_search_result/tm_riwayat_langganan_su_result_controller.dart';
import 'package:muatmuat/app/routes/app_pages.dart';
import 'package:muatmuat/app/utils/shared_preferences_helper.dart';

class TMSubscriptionRiwayatLanggananSUListSearchController
  ...
  Future<void> getHistory() async {
    try {
      var resultJson =
          jsonDecode(await SharedPreferencesHelper.getHistoryTMSubscriptionSU())
              as List;
  ...
  void updateHistory() async {
    ...
    await SharedPreferencesHelper.setHistoryTMSubscriptionSU(
  ...
  void onSubmitSearch() {
    updateHistory();
    TMSubscriptionRiwayatLanggananSUListSearchResultController
    ...
    if (searchResultController != null)
      ...
      Get.offNamed(
          Routes.TM_SUBSCRIPTION_RIWAYAT_LANGGANAN_SU_LIST_SEARCH_RESULT,
          arguments: [
            search
            // , filterTransporter
            // , sortShipper
