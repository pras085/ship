...
class ApiTMSubscription {
  ...
  Future getDetailOrderByShipper(Map<String, dynamic> body) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_detail_order_by_shipper", body);
  }

  Future getDetailOrderSubusersByShipper(Map<String, dynamic> body) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_detail_order_subusers_by_shipper",
            body);
  }
  ...
  Future getCheckSegmented(
    ...
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/check_segmented_user_tm", body);
  }

  Future fetchPaketLanggananSubuser(
      int paketLanggananID, String usedPaketSubuser,
      {bool nextLangganan = false,
      //halaman layanan dalam file disebut bigfleet tidak ada hubungannya dengan transport market
    ...
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_paket_sub_users", body);
  }

  Future getTimelineSubscription(Map<String, dynamic> body) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_timeline_subscription", body);
  }
  ...
  Future getDashboardSubscriptionShipper() async {
    ...
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_dashboard_subscription_shipper",
            body);
  }
  ...
  Future getRiwayatLangganan(Map<String, dynamic> body) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_riwayat_langganan", body);
  }

  Future getRiwayatSubUsers(Map<String, dynamic> body) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_riwayat_sub_users", body);
  }
  ...
  Future doAddSubscription(List paketSubuser, String paketID, String voucherID,
    ...
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/doAddOrderSubscriptionTMByShipper",
            body);
  }
  ...
  Future getPeriodePaketSubuser(String subscriptionID, String paketID) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_periode_paket_subusers", {
      "Role": "2",
  ...
  Future cekPeriodePaketSubuser(
    ...
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/get_periode_subscription", {
      "Role": "2",
      "SubscriptionID": subscriptionID,
      "PaketID": paketID,
      "Tanggal": tanggal
  ...
  Future doAddSubuser(List paketSubuser, String subscriptionID,
    ...
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/doAddOrderSubscriptionSubUsersByShipper",
            body);
  }
  ...
  Future getPacketSubscriptionActiveByShipper(Map<String, dynamic> body) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo +
                "backend/get_packet_subscription_active_by_shipper",
            body);
  }
  ...
  Future doUpdatePaymentSubscription(
    ...
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/doUpdatePaymentMethodForShipper",
  ...
  Future doUpdateStatusOrderSubscription(String orderID) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/doPaymentSubscriptionTMByShipper",
            {"OrderID": orderID});
  }
  ...
  Future doUpdateStatusOrderSubuser(String orderID, String isNext) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/doPaymentSubscriptionSubUsersByShipper",
  ...
  Future doCancelOrderSubscription(String orderID, String notes) async {
    return await ApiHelper(context: context, isShowDialogLoading: false)
        .fetchDataFromUrlPOSTMuatMuatAfterLogin(
            ApiHelper.urlzo + "backend/doCancelOrderSubscriptionTMByShipper",
