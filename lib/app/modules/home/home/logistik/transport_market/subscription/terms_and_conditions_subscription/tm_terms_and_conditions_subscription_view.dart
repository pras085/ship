...
class TMTermsAndConditionsSubscriptionView
    extends GetView<TMTermsAndConditionsSubscriptionController> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarDetail(
        title: ('SubscriptionCreateLabelTnCTransportMarket'.tr)
            .replaceAll("\\n", "\n"),
      ),
      body: Container(
  ...
  Widget _getDetailTermsAndCondition(
    TM_TACPointModel termsAndConditionsPointModel,
    int index,
  ) {
