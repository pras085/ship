...
class AfterLoginSubUserView extends GetView<AfterLoginSubUserController> {
                                                    ...
                                                    Expanded(
                                                        ...
                                                        child: MaterialButton(
                                                          ...
                                                          color: Color(
                                                              ListColor.color4),
                                                          onPressed: () {
                                                            GetToPage.toNamed<RegisterController>(Routes.REGISTER_USER);
                                                          },
                                                          child: CustomText(
                                          ...
                                          Positioned.fill(
                                              ...
                                              child: Align(
                                                  ...
                                                  child: GestureDetector(
                                                      onTap: () {
                                                        controller.openOtherApps(
                                                            "com.azlogistik.muatmuat");
                                                      },
                                                      child: Container(
                                                        width: GlobalVariable
                                                                .ratioWidth(Get
                                                      ...
                                                      Container(
                                                          ...
                                                          child: x ==
                                                              ...
                                                              ? GestureDetector(
                                                                  ...
                                                                  child: Container(
                                                                      width: GlobalVariable.ratioWidth(Get.context) * 140,
                                                                      height: GlobalVariable.ratioWidth(Get.context) * 270,
                                                                      decoration: BoxDecoration(
                                                                          borderRadius: BorderRadius.circular(GlobalVariable.ratioWidth(Get.context) * 8),
                                                                          border: Border.all(width: GlobalVariable.ratioWidth(Get.context) * 1, color: Color(ListColor.color4)),
                                                                          boxShadow: [
                                                                            BoxShadow(
                                                                          ...
                                                                          image: DecorationImage(
                                                                              image: AssetImage(
                                                                                GlobalVariable.imagePathArk + "lihat_penawaran_lainnya.png",
                                                                              ),
                                                                              fit: BoxFit.cover)),
                                                                      child: Stack(
                                                                        children: [
                                                              ...
                                                              : CardProduct(
                                                                  ...
                                                                  price: double.parse(controller.transporationStoreList[x]['Harga']),
                                                      ...
                                                      Container(
                                                          ...
                                                          margin: EdgeInsets.only(
                                                              left: x == 0
                                                                  ? GlobalVariable.ratioWidth(Get.context) *
                                                                      16
                                                                  : 0,
                                                              right: (x < controller.dealerKaroseriList.length - 1
                                                                  ? GlobalVariable.ratioWidth(Get.context) *
                                                                      10
                                                                  : GlobalVariable.ratioWidth(Get.context) *
                                                                      16)),
                                                          child: x ==
                                                              ...
                                                              ? GestureDetector(
                                                                  ...
                                                                  child: Container(
                                                                      width: GlobalVariable.ratioWidth(Get.context) * 140,
                                                                      height: GlobalVariable.ratioWidth(Get.context) * 368,
                                                                      decoration: BoxDecoration(
                                                                          borderRadius: BorderRadius.circular(GlobalVariable.ratioWidth(Get.context) * 8),
                                                                          border: Border.all(width: GlobalVariable.ratioWidth(Get.context) * 1, color: Color(ListColor.color4)),
                                                                          boxShadow: [
                                                              ...
                                                              : CardProduct(
                                                                  ...
                                                                  price: double.parse(controller.dealerKaroseriList[x]['Harga'].length > 0 ? controller.dealerKaroseriList[x]['Harga'][0]['Harga_harga'] : '0'), // Tidak Ada Response
                                                    ...
                                                    for (var x = 0;
                                                      ...
                                                      Container(
                                                          ...
                                                          child: CardCompany(
                                                              ...
                                                              favorite: controller.repairMaintenanceList[x]['favorit'] == "1"
                                                                  ? true
                                                                  : false,
                                                              verified: controller.repairMaintenanceList[x]['isverified'] == "1"
                                                                  ? true
                                                                  : false,
                                                              highlight:
                                                                  controller.repairMaintenanceList[x]['ishighlight'] == "1"
                                                                      ? true
                                                                      : false,
                                                      ...
                                                      Container(
                                                          ...
                                                          margin: EdgeInsets.only(
                                                              left: x == 0
                                                                  ? GlobalVariable.ratioWidth(Get.context) *
                                                                      16
                                                                  : 0,
                                                              right: (x < controller.propertyWarehouseList.length - 1
                                                                  ? GlobalVariable.ratioWidth(Get.context) *
                                                                      10
                                                                  : GlobalVariable.ratioWidth(Get.context) *
                                                                      16)),
                                                          child: x ==
                                                              ...
                                                              ? GestureDetector(
                                                                  ...
                                                                  child: Container(
                                                                      width: GlobalVariable.ratioWidth(Get.context) * 140,
                                                                      height: GlobalVariable.ratioWidth(Get.context) * 305,
                                                                      decoration: BoxDecoration(
                                                                          borderRadius: BorderRadius.circular(GlobalVariable.ratioWidth(Get.context) * 8),
                                                                          border: Border.all(width: GlobalVariable.ratioWidth(Get.context) * 1, color: Color(ListColor.color4)),
                                                                          boxShadow: [
                                                              ...
                                                              : CardProduct(
                                                                  ...
                                                                  price: double.parse(controller.propertyWarehouseList[x]['Harga']), // Tidak Ada Response
        ...
        children: [
          ...
          Container(
            ...
            child: Wrap(
              ...
              spacing: GlobalVariable.ratioWidth(Get.context) * 20,
              runSpacing: GlobalVariable.ratioWidth(Get.context) * 18,
              children: listData,
            ),
          ),
        ],
