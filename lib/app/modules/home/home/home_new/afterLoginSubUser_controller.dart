...
class AfterLoginSubUserController extends GetxController {
  ...
  Future getRepairMaintanance() async {
    ...
    var result = await ApiHelper(
            ...
            isShowDialogLoading: false,
            isShowDialogError: false)
        .getListBuyer("repair & maintenance", 3, login);
  ...
  Widget menuWidget(data, x) {
    return GestureDetector(
            ...
            if (login) {
              ...
              if (dataUser['IsSubUser'] == 0) {
                ...
                if ((GlobalVariable.role == "2" &&
                  ...
                  showDialogAkses('ManajemenUserLandingPageTransportMarket'.tr);
                }
              }
              ...
              popUpDaftar();
              // GlobalAlertDialog.showAlertDialogCustom(context: Get.context, title: "Info", message: "Sedang dalam pengembangan", labelButtonPriority1: "Tutup", ); 
            }
          } 
        ...
        child: Container(
          ...
          width: ((MediaQuery.of(Get.context).size.width -
                  (GlobalVariable.ratioWidth(Get.context) * 72)) /
              3),
  ...
  void openOtherApps(String packageName) async {
    AppAvailability.launchApp(packageName).then((_) {
      ...
      print("App not found!");
      // OpenAppstore.launch(
      //     androidAppId: "com.miHoYo.GenshinImpact", iOSAppId: "");
    });
    // if(result){
