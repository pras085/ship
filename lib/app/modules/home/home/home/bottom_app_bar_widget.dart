...
class BottomAppBarMuat extends StatefulWidget {
  BottomAppBarMuat({
    this.items,
    this.centerItemText,
    this.height: 60.0,
  ...
  @override
  State<StatefulWidget> createState() => BottomAppBarMuatState();
}

class BottomAppBarMuatState extends State<BottomAppBarMuat> {
