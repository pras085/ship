...
class Navbar extends StatelessWidget {
  ...
  Navbar({this.selectedIndex = -1, this.onTap1, this.onTap2, this.onTap3, this.onTap4});
  ...
  Widget build(BuildContext context) {
    ...
    _menus = [ 
      {'icon': 'assets/ic_navbar_home_template.svg', 'title': 'Home'},
      {'icon': 'assets/ic_navbar_message_template.svg', 'title': 'Inbox'},
      {'icon': 'assets/ic_navbar_shop_template.svg', 'title': 'Pasang Iklan'},
      {'icon': 'assets/ic_navbar_user_template.svg', 'title': 'Profile'},
    ];

    if (selectedIndex != -1) {
      if (selectedIndex == 0) _menus[selectedIndex]['icon'] = GlobalVariable.urlImageTemplateBuyer + 'ic_navbar_home_active_template.svg';
      if (selectedIndex == 1) _menus[selectedIndex]['icon'] = GlobalVariable.urlImageTemplateBuyer + 'ic_navbar_message_active_template.svg';
      if (selectedIndex == 2) _menus[selectedIndex]['icon'] = GlobalVariable.urlImageTemplateBuyer + 'ic_navbar_shop_active_template.svg';
      if (selectedIndex == 3) _menus[selectedIndex]['icon'] = GlobalVariable.urlImageTemplateBuyer + 'ic_navbar_user_active_template.svg';
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomText(
                    ...
                    fontSize: 12,
                    height: 1.2,
                    color: Color(selectedIndex == index ? ListColor.colorBlueTemplate : ListColor.colorGreyTemplate1)
                  )
                ],
              ),
            ),
